...
public class NatsClientReconnectBufferTest extends AbstractNatsIntegrationTestSupport {
	...
	public static class ContextConfig {
		...
		@Autowired
		private @Qualifier("natsConnectionDefaultBuffer")
		Connection natsConnectionDefaultBuffer;

		@Autowired
		private @Qualifier("natsConnectionCustomBuffer")
		Connection natsConnectionCustomBuffer;
